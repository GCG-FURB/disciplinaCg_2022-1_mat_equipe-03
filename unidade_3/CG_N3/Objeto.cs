...
namespace gcgcg
{
  ...
  private static Transformacao4D matrizTamanho = new Transformacao4D();
  ...
  public void tamanho(double x, double y, double z)
    {
      ...
      Objeto.matrizTamanho.AtribuirEscala(x, y, z);
      Objeto.matrizGlobal = Objeto.matrizTamanho.MultiplicarMatriz(Objeto.matrizGlobal);
